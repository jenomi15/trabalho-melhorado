...
public class Tabuleiro {
    ...
    public void criacaoDoTabuleiro() {
        ...
        // Inicializa o tabuleiroJogado com a capacidade total
        ...
        for (String tipo : tiposDeCasas) {
            ...
            for (int i = 0; i < quantidade; i++) {
                ...
                // Cria casas com parâmetros adicionais ou simples, conforme necessário
                Casa novaCasa;
                ...
                // Adiciona a nova casa na posição correta
                tabuleiroJogado.set(numero, novaCasa);
            }
        }
    
        // Verifica se todas as posições foram preenchidas e substitui as nulas por casas simples
    ...
    public void TurnoDoJogoDebug() {
        ...
        while (!jogoTerminou()) {
            for (int a = 0; a < jogadores.size(); a++) {
                ...
                // Modo Debug: Pergunta a posição para a qual o jogador deve ir
