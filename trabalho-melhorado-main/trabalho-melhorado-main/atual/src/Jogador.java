public   class Jogador  implements Comparable<Jogador> , JogadorBase {
    private String nome;
    private String cor;
    private int tipo;
    ...
    public int getMoedasCasaSimples() {
        throw new UnsupportedOperationException("Unimplemented method 'getMoedasCasaSimples'");
    }
    ...
    public void adicionarMoedas(JogadorBase jogador, int moedasCasaSimples) {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'adicionarMoedas'");
    }
