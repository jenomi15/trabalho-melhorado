public abstract class Jogador implements Comparable<Jogador>, JogadorBase {
    ...
    protected boolean boné;
    protected boolean moleton;
    protected boolean óculosEscuros;
    ...
    public Jogador(String cor, int numeroCasa, int pulaProximaRodada ,  boolean boné , boolean moleton  ,boolean óculosEscuros  ) {
        ...
        this.moleton = moleton;
        this.óculosEscuros = óculosEscuros;
        this.boné = boné;
    }
