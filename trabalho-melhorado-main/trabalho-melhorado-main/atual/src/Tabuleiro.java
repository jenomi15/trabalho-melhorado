...
public class Tabuleiro {
    ...
    public void criacaoDoTabuleiro() {
        ...
        System.out.println("Quantas casas deseja criar?");
        int quantidade = scanner.nextInt();
        scanner.nextLine();  

        for (int i = 0; i < quantidade; i++) {
            System.out.println("Digite o número da casa " + (i + 1) + ":");
            int numero = scanner.nextInt();
            scanner.nextLine();  

            System.out.println("Digite o tipo da casa " + (i + 1) + " (surpresa, sorte, simples, reversa, prisao, jogadenovo, azar, troca):");
            String tipo = scanner.nextLine().toLowerCase();
            Casa novaCasa;
            if (tipo.equals("sorte") || tipo.equals("reversa") || tipo.equals("jogadenovo" )) {
            ...
            tabuleiroJogado.add(novaCasa); //para adicionar cor nas casas so botar casa como parametro , e pegar casa.cores sla e add a cor por adicionar cor casa
        }
    ...
    public void TurnoDoJogo() {
        ...
        for (int i = 0; i < jogadores.size(); i++) {
            ...
            System.out.println((i + 1) + "º lugar: Jogador " + jogador.getCor() + " - Casa " + jogador.getNumeroCasa() + " - número de jogadas: " + jogador.getNumeroCasa());
        }
    }
    ...
    public void TurnoDoJogoDebug() {
        ...
        while (!jogoTerminou()) {
            for (int a = 0; a < jogadores.size(); a++) {
                ...
                System.out.println("Turno do jogador N* " + (a + 1) + " (" + jogadores.get(a).getCor() + "), insira o número da casa para onde ele deverá ir.");
                ...
                int posicaoAntiga = jogadores.get(a).getNumeroCasa();
                System.out.println(" \n Posição antiga do jogador " + jogadores.get(a).getCor() + ": " + posicaoAntiga);
                System.out.println("\n Nova posição definida para o jogador " + jogadores.get(a).getCor() + ": " + novaPosicao);
