    ...
    public void TurnoDoJogo() {
        ...
        while (!jogoTerminou()) {
            for (int a = 0; a < jogadores.size(); a++) {
                if (jogadores.get(a).getNumeroCasa() >= tabuleiroJogado.size() - 1) {
                    System.out.println("O jogador " + jogadores.get(a).getCor() + " venceu o jogo!");
                ...
                if (jogadores.get(a).pulaRodada() > 0) {
                    System.out.println("O jogador " + jogadores.get(a).getCor() + " que possui um número de moedas = " + jogadores.get(a).getPontuacaoEmMoedas() + " está pulando esta rodada.");
                    jogadores.get(a).setPulaProximaRodada(0);
                    continue; // Passa para o próximo jogador
                }
    
                int numeroRealDaCasa = jogadores.get(a).getNumeroCasa();
                System.out.println("Turno do jogador N* " + (a + 1) + " (" + jogadores.get(a).getCor() + " que possui um número de moedas = " + jogadores.get(a).getPontuacaoEmMoedas() + "), role os dados.");
                ResultadoDados resultado = jogadores.get(a).rolarDados();
                int posicaoAntiga = jogadores.get(a).getNumeroCasa();
                System.out.println("\n Posição antiga do jogador " + "que possui um número de moedas = " + jogadores.get(a).getPontuacaoEmMoedas() + " " + jogadores.get(a).getCor() + ": " + posicaoAntiga);
                ...
                System.out.println("\n Nova posição calculada para o jogador " + jogadores.get(a).getCor() + " que possui um número de moedas = " + jogadores.get(a).getPontuacaoEmMoedas() + ": " + novaPosicao);
    
                jogadores.get(a).setNumeroCasa(novaPosicao);
    
                removerCorCasa(numeroRealDaCasa, jogadores.get(a).getCor());
                ...
                if (resultado.isIguais()) {
                    System.out.println("O jogador que possui um número de moedas = " + jogadores.get(a).getPontuacaoEmMoedas() + " " + jogadores.get(a).getCor() + " rolou dois dados iguais e joga novamente.");
        ...
        for (int i = 0; i < jogadores.size(); i++) {
            ...
            System.out.println((i + 1) + "º lugar: Jogador " + jogador.getCor() + " - Casa que possui um número de moedas = " + jogador.getPontuacaoEmMoedas() + jogador.getNumeroCasa() + " - número de jogadas: " + jogador.getNumeroCasa());
        }
    }
