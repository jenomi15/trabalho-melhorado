...
public class JogadorAzarado extends Jogador {
    ...
    public JogadorAzarado(String cor, int numeroCasa , int pulaProximaRodada , int numeroDeJogadas , int pontuacaoEmModedas , boolean boné , boolean moleton , boolean óculosEscuros ) {
